...
<head>
  ...
  <title>Admin Database Kader</title>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{ asset('Dashboard_admin/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="{{ asset('Dashboard_admin/index2.html') }}" class="h1"><b>Admin</b>LTE</a>
    </div>
    <div class="card-body">
      ...
      <p class="mb-0">
        <a href="/login" class="text-center">Login o</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
...
<!-- AdminLTE App -->
<script src="{{ asset('Dashboard_admin/dist/js/adminlte.min.js') }}"></script>
</body>
</html>
